...
public class ReservationControllerTest {
    ...
    public void createReservation_ValidInput_ThenReturnReservationResponseModel() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/v1/reservations?appointmentId="+appointment.getId())
    ...
    public void changeReservationStatus_ValidInput_ThenReturnReservationResponseModel() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.put("/api/v1/reservations/1?status=CANCELED")
                .contentType(MediaType.APPLICATION_JSON);
